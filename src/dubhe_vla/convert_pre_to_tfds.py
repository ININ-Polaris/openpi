        ...
        step_feature = tfds.features.FeaturesDict(
            {
                "action": tfds.features.Tensor(
                    shape=(16,), dtype=tf.float32, doc="Robot action for joints in two arms + grippers."
                ),
                ...
                "observation": tfds.features.FeaturesDict(
                    {
                        "state": tfds.features.Tensor(
                            shape=(16,), dtype=tf.float32, doc="Robot joint pos (two arms + grippers)."
                        ),
                        # 固定分辨率 JPEG
                        "mid": tfds.features.Image(
                            shape=(480, 848, 3), encoding_format="jpeg", doc="RGB camera observation."
                        ),
                        "right": tfds.features.Image(
                            shape=(240, 424, 3), encoding_format="jpeg", doc="RGB camera observation."
                        ),
                        "left": tfds.features.Image(
                            shape=(240, 424, 3), encoding_format="jpeg", doc="RGB camera observation."
                        ),
                    }
                ),
...
# uv run src/dubhe_vla/convert_pre_to_tfds.py --prep_dir tf --data_dir output --name pick_apple
